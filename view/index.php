...
<body>
                                ...
                                <nav>
                                    <ul id="navigation">
                                        ...
                                        <script>
                                            ...
                                            var targetOffset = $("#our_volunteer_area").offset().top;
    ...
    <div id="our_volunteer_area" class="our_volunteer_area section_padding">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section_title text-center mb-55">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="single_volenteer">
                        <div class="volenteer_thumb">
                            <img src="../assets/img/volenteer/1.jpg" alt="">
                        </div>
                        <div class="voolenteer_info d-flex align-items-end">
                            <div class="social_links">
                                <ul>
                                    <li>
                                        <a href="https://www.facebook.com/bchemkh/"> <i class="fa fa-facebook"></i> </a>
                                    </li>
                                    <li>
                                        <a href="https://www.linkedin.com/in/badreddine-chamkhi-458103232/"> <i class="fa fa-linkedin"></i> </a>
                                    </li>
                                    <li>
                                        <a href="https://twitter.com/retr0rocks"> <i class="fa fa-twitter"></i> </a>
                                    </li>
                                    <li>
                                        <a href="https://github.com/retr0Rocks"> <i class="fa fa-github"></i> </a>
                                    </li>
                                </ul>
                            </div>
                            <div class="info_inner">
                                <h4>Badreddine Chamkhi</h4>
                                <p>retr0</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_volenteer">
                        <div class="volenteer_thumb">
                            <img src="../assets/img/volenteer/2.jpg" alt="">
                        </div>
                        <div class="voolenteer_info d-flex align-items-end">
                            <div class="social_links">
                                <ul>
                                    <li>
                                        <a href="https://www.facebook.com/profile.php?id=100028965942318"> <i class="fa fa-facebook"></i> </a>
                                    </li>
                                    <li>
                                        <a href="https://www.linkedin.com/in/youssef-ben-lallahom-43b970250/"> <i class="fa fa-linkedin"></i> </a>
                                    </li>
                                    <li>
                                        <a href="https://www.instagram.com/youssef_ben_lallahom/"> <i class="fa fa-instagram"></i> </a>
                                    </li>
                                    <li>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_volenteer">
                        <div class="volenteer_thumb">
                            <img src="../assets/img/volenteer/3.jpg" alt="">
                        </div>
                        <div class="voolenteer_info d-flex align-items-end">
                            <div class="social_links">
                                <ul>
                                    <li>
                                        <a href="https://www.facebook.com/hidaya.hanafi.03"> <i class="fa fa-facebook"></i> </a>
                                    </li>
                                    <li>
                                        <a href="https://www.linkedin.com/in/hidaya-hanafi-21914a264/"> <i class="fa fa-linkedin"></i> </a>
                                    </li>
                                    <li>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_volenteer">
                        <div class="volenteer_thumb">
                            <img src="../assets/img/volenteer/4.jpg" alt="">
                        </div>
                        <div class="voolenteer_info d-flex align-items-end">
                            <div class="social_links">
                                <ul>
                                    <li>
                                        <a href="https://www.facebook.com/omar.dachraoui58"> <i class="fa fa-facebook"></i> </a>
                                    </li>
                                    <li>
                                        <a href="https://www.linkedin.com/in/omar-dachraoui-78a6542a4"> <i class="fa fa-linkedin"></i> </a>
                                    </li>
                                    <li>
                                        <a href="https://www.instagram.com/dachraoui_omar/"> <i class="fa fa-instagram"></i> </a>
                                    </li>
                                </ul>
                            </div>
                            <div class="info_inner">
                                <h4>Omar Dachraoui</h4>
                                <p>Dach</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_volenteer">
                        <div class="volenteer_thumb">
                            <img src="../assets/img/volenteer/5.jpg" alt="">
                        </div>
                        <div class="voolenteer_info d-flex align-items-end">
                            <div class="social_links">
                                <ul>
                                    <li>
                                        <a href="https://www.facebook.com/mehdi.ayachi.79"> <i class="fa fa-facebook"></i> </a>
                                    </li>
                                    <li>
                                        <a href="https://www.linkedin.com/in/mehdi-ayachi/"> <i class="fa fa-linkedin"></i> </a>
                                    </li>
                                    <li>
                                        <a href="https://www.instagram.com/mehdi.ayachi_/"> <i class="fa fa-instagram"></i> </a>
                                    </li>
                                </ul>
                            </div>
                            <div class="info_inner">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_volenteer">
                        <div class="volenteer_thumb">
                            <img src="../assets/img/volenteer/6.jpg" alt="">
                        </div>
                        <div class="voolenteer_info d-flex align-items-end">
                            <div class="social_links">
                                <ul>
                                    <li>
                                        <a href="https://www.facebook.com/mohmedyassine.abidi"> <i class="fa fa-facebook"></i> </a>
                                    </li>
                                    <li>
